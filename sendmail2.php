...
*/
   ...
   $respheaders = 'From: support@facednatest.com'."\r\n".'Content-Type: text/plain;charset = UTF-8';
    ...
    $separator = md5(time());
    $eol = "\r\n";
$respheaders .= "MIME-Version: 1.0" . $eol;
    $respheaders .= "Content-Type: multipart/mixed; boundary=\"" . $separator . "\"" . $eol;
    $respheaders .= "Content-Transfer-Encoding: 7bit" . $eol;
$file_to_attach = __DIR__ . '/reports/'. $repnum . '.pdf';
$body = "--" . $separator . $eol;
    $body .= "Content-Type: text/plain; charset=\"iso-8859-1\"" . $eol;
    $body .= "Content-Transfer-Encoding: 8bit" . $eol;
    $body .= $autoresponse . $eol;

if (file_exists($file_to_attach)) {
    $content = file_get_contents($file_to_attach);
 ...
 // attachment
    ...
    $email=mail($_POST['email'],"Your submission has been received.", $body, $respheaders);
    $obj = '{
    "status" : '.$email.'}';
echo $obj;
?>
